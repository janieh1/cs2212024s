...
private:
    ...
    int n1; // keep track of num empty elements?? inc everytime we pop left
    int n2; // keep track of num of cont elements?? inc when we push left, dec when we pop right
};
